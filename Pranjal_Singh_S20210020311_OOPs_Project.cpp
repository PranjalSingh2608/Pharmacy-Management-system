...
#define max 10
using namespace std;
/*Medicine Class will contain all the functions such as taking order,deleting order,modifying order,
displaying order list,displaying daily summary,and displaying list of customers
*/
class medicineType{
public:
    void take_order();
...
// struct is created to hold the recored of each customer and work with medicineType class
struct node{
	int reciept_number;
	string customerName;
	string date;
...
int main(){
	...
	do{
		...
		cout<<"\t\t||\t6. Display available medicines \t\t ||\n";
		cout<<"\t\t||\t7. Display the list of customers \t ||\n";
		cout<<"\t\t||\t8. Exit\t\t\t\t\t ||\n";
		cout<<"\t\t--------------------------------------------------\n";
		cout<<"Enter choice: ";
...
void medicineType::take_order(){
	...
	//copying the contents into file
	cout << "Type Order no: ";
    cin >> temp->reciept_number;
	out << "Order Number : " << temp->reciept_number << endl;
...
void medicineType::order_list(){
	...
	temp=start_ptr;
	found = false;
	//display the order list of the customers whose sidmatches with entered reciept number
...
void medicineType::delete_order()	
{
	...
	node *temp;
	bool found;
	//if entered sid matches with the sid we want to delete then the loop will delete that entry
	if(start_ptr == NULL)
...
void medicineType::modify()		
{
 ...
 cin>>sid;
 //checking if ssid matches with entered id in order to modify the order
 if (temp==NULL && sid==0)
 {
 ...
 else
 {
    ...
    cin >> temp->reciept_number;
	out << "Reciept Number : " << temp->reciept_number << endl;
...
void medicineType::daily_summary()		
{
	...
	else
	{
		...
		cout<<"==========================================================================="<<endl;
	//displaying the list of total customers
		while(temp!=NULL)
		{
...
void medicineType::displayMedicine()
{
    system("CLS");
    cout << "=====================================================" << endl;
...
void medicineType::displayCustomers()
{
    system("CLS");
    cout << "=====================================================" << endl;
